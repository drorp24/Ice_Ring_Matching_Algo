...
class BasicFleetReaderTestCase(unittest.TestCase):
    ...
    def test_formation_size_policy(self):
        ...
        self.assertEqual(formation_size_policy_property_set.formation_size_policy[FormationSize.MINI], 0.5)
        self.assertEqual(formation_size_policy_property_set.formation_size_policy[FormationSize.MEDIUM], 0.5)
    ...
    def test_drone_configuration_policy(self):
        ...
        self.assertEqual(platform_configuration_policy.configurations_policy[Configurations.LARGE_X2], 0.4)
