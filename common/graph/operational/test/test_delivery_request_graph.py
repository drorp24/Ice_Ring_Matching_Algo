...
class BasicDeliveryRequestGraphTestCases(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.delivery_request_list_1_morning_only = [create_delivery_request_from_dict(dr) for dr in
                                                    create_delivery_requests_dict()]
        cls.delivery_request_list_2 = [create_delivery_request_from_dict(dr) for dr in create_delivery_requests_dict()]
        cls.delivery_request_list_2_low_priority_only = [create_delivery_request_from_dict(dr) for dr in
                                                         create_delivery_requests_dict()]
