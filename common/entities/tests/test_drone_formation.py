...
class BasicDroneFormationTypeGeneration(unittest.TestCase):
    ...
    def test_package_type_size(self):
        self.assertEqual(self._2X_PLATFORM_1_2X8.get_package_type_volume(PackageType.LARGE), 4)
        self.assertEqual(self._4X_PLATFORM_1_2X8.get_package_type_volume(PackageType.LARGE), 8)
        self.assertEqual(self._2X_PLATFORM_1_4X4.get_package_type_volume(PackageType.MEDIUM), 8)
        self.assertEqual(self._4X_PLATFORM_1_4X4.get_package_type_volume(PackageType.MEDIUM), 16)
        self.assertEqual(self._2X_PLATFORM_2_4X8.get_package_type_volume(PackageType.LARGE), 8)
        self.assertEqual(self._4X_PLATFORM_2_8X4.get_package_type_volume(PackageType.MEDIUM), 32)
        self.assertEqual(self._2X_PLATFORM_2_16X2.get_package_type_volume(PackageType.SMALL), 32)
        self.assertEqual(self._2X_PLATFORM_2_32X1.get_package_type_volume(PackageType.TINY), 64)
