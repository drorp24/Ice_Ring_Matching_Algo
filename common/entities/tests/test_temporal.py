...
class BasicDateTime(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        expected_dict = {'__class__': 'DateTimeExtension', 'date': date(2010, 10, 1), 'time': time(6, 10, 5)}
    ...
    def test_time_window_to_dict(self):
        ...
        expected_dict = {'__class__': 'TimeWindowExtension',
                         'since': {'__class__': 'DateTimeExtension', 'date': date(2010, 10, 1), 'time': time(6, 10, 5)},
                         'until': {'__class__': 'DateTimeExtension', 'date': date(2010, 10, 1), 'time': time(7, 12, 5)}}
