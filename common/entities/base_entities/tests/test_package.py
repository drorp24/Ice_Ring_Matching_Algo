...
class BasicPackageTestCase(unittest.TestCase):
    ...
    def test_package_weights(self):
        ...
        self.assertEqual(PackageType.TINY.value.minimal_radius_meters, 900)
        self.assertEqual(PackageType.SMALL.value.weight, 2)
        self.assertEqual(PackageType.SMALL.value.maximal_radius_meters, 500)
        self.assertEqual(PackageType.SMALL.value.minimal_radius_meters, 450)
        self.assertEqual(PackageType.MEDIUM.value.weight, 4)
        self.assertEqual(PackageType.MEDIUM.value.maximal_radius_meters, 250)
        self.assertEqual(PackageType.MEDIUM.value.minimal_radius_meters, 225)
        self.assertEqual(PackageType.LARGE.value.weight, 8)
        self.assertEqual(PackageType.LARGE.value.maximal_radius_meters, 125)
        self.assertEqual(PackageType.LARGE.value.minimal_radius_meters, 112.5)
