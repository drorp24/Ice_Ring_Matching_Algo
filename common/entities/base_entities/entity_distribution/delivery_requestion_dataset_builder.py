...
from common.entities.base_entities.entity_distribution.delivery_request_distribution import DEFAULT_DR_PRIORITY_DISTRIB, \
    PriorityDistribution, DEFAULT_TW_DR_DISRIB, DeliveryRequestDistribution
...
def build_delivery_request_distribution(
        ...
        time_window_distribution: TimeWindowDistribution = DEFAULT_TW_DR_DISRIB) -> DeliveryRequestDistribution:
