...
class DroneLoadingDock:
    ...
    def __init__(self, drone_loading_station: DroneLoadingStation, platform_type: PlatformType,
...
class DroneLoadingDockDistribution(Distribution):
    ...
    def __init__(self, platform_type_distribution: PlatformTypeDistribution =
    DEFAULT_PLATFORM_TYPE_DISTRIBUTIONS,
    ...
    def choose_rand(self, random: Random, amount: int) -> [DroneLoadingDock]:
