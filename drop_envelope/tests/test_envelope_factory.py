...
from common.math.angle import NoneAngle, Angle, AngleUnit
...
class BasicSlideTestCase(unittest.TestCase):
    ...
    def test_create_drop_envelope(self):
        ...
        drop_envelope_without_drop_azimuth = get_drop_envelope(drop_azimuth=NoneAngle(),
    ...
    def test_create_potential_drop_envelopes(self):
        potential_drop_envelope_without_drop_azimuth = get_potential_drop_envelope(drop_azimuth=NoneAngle(),
                                                                                   package_type=self.package_type,
                                                                                   drop_point=self.drop_point)
