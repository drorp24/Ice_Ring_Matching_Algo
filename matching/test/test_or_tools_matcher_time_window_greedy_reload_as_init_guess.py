...
# from geometry.distribution.geo_distribution import ExactPointLocationDistribution, UniformPointInBboxDistribution
...
#
#
# class ORToolsMatcherTimeWindowGreedyReloadAsInitGuessTestCase(TestCase):
#     @classmethod
#     def setUpClass(cls):
...
#
#     def test_matcher_when_time_window_greedy_reload_as_init_guess_then_solution_improves(self):
#         tw_matcher = MatchingMaster(self.tw_match_input)
#         tw_actual_delivery_board = tw_matcher.match()
#         tw_as_init_guess_actual_delivery_board = tw_matcher.match_with_time_greedy_as_init_guess()
#         # tw_as_init_guess_actual_delivery_board = ORToolsMatcher(self.tw_match_input).match()
#         total_packages_of_tw_actual_delivery_board = \
#             tw_actual_delivery_board.get_total_amount_per_package_type(
#             ).get_package_type_amount(PackageType.LARGE)
#         total_packages_of_tw_as_init_guess_actual_delivery_board = \
#             tw_as_init_guess_actual_delivery_board.get_total_amount_per_package_type(
#             ).get_package_type_amount(PackageType.LARGE)
#         self.assertGreater(
#             total_packages_of_tw_as_init_guess_actual_delivery_board,
#             total_packages_of_tw_actual_delivery_board)
...
#             relative_pdp_location_distribution=UniformPointInBboxDistribution(min_x=0, max_x=20, min_y=0, max_y=20),
#             time_window_distribution=ExactTimeWindowDistribution(20 * [
#                 TimeWindowExtension(
#                     since=ZERO_TIME,
...
#             priority_distribution=ExactPriorityDistribution(list(range(1, 21)))
#         )
#         return dist.choose_rand(Random(42), amount={DeliveryRequest: 20})
#
#     @staticmethod
