...
class BasicPointTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.p1 = Geo2D.create_point_2d(42, -42)
...
class BasicPointMathTestCase(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.p1 = Geo2D.create_point_2d(0, 0)
        cls.p2 = Geo2D.create_point_2d(10, 0)

    def test_point_addition(self):
        result = self.p1.add_vector(self.p2.to_vector())
        self.assertEqual(result.type, 'Point')
        self.assertEqual(result, Geo2D.create_point_2d(10, 0))

    def test_point_subtraction(self):
        result = self.p1.subtract_point(self.p2)
        self.assertEqual(result.type, 'Vector')
        self.assertEqual(result, Geo2D.create_vector_2d(-10, 0))
