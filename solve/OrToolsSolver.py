...
def create_data_model():
    ...
    data['priorities'] = [0, 1000, 1000, 2, 4, 2, 4, 3, 3, 1, 5, 1, 2, 4, 15, 3, 15]
...
def print_solution(data, manager, routing, assignment):
    ...
    for vehicle_id in range(data['num_vehicles']):
        ...
        while not routing.IsEnd(index):
            ...
            route_priority += data['priorities'][node_index]
...
def main():
    ...
    def priority_callback(from_index):
        ...
        from_node = manager.IndexToNode(from_index)
        return data['priorities'][from_node]

    priority_callback_index = routing.RegisterUnaryTransitCallback(priority_callback)
    priority = 'Priority'
    routing.AddDimension(
