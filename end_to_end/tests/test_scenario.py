...
class BasicScenarioTests(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.scenario = ScenarioDistribution().choose_rand(random=Random(),
    ...
    def test_writing_scenario(self):
        self.scenario.to_json(self.test_json_file_name)
        loaded_scenario_dict = Scenario.json_to_dict(self.test_json_file_name)
